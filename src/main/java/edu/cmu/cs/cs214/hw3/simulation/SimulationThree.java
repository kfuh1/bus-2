 ...
 * This one would have the best distribution of entities, so supposedly
 * the least delays.
 */
public class SimulationThree {
    ...
    private static final double PCT_RFID = 100.0;
    private static final double PCT_LUGGAGE = 0.0;
    private static final double PCT_DELAYS = 0.0;
    /**
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                new SimulationThree().createAndShowSimulation();
            }
        });
    }
